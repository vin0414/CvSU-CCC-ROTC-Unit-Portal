                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                                ...
                                <li class="nav-item">
                                    <a href="#tabs-borrow-8" class="nav-link" data-bs-toggle="tab">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <li class="nav-item">
                                    <a href="#tabs-return-8" class="nav-link" data-bs-toggle="tab">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tabs-borrow-8">
                                ...
                                <div class="tab-pane fade" id="tabs-return-8">
                                    <table class="table table-bordered table-striped" id="tblreturned">
                                        <thead>
                                            <th>Date Returned</th>
                                            <th>Item</th>
                                            <th>Quantity</th>
