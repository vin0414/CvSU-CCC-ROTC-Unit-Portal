...
<body>
        ...
        <div class="page-wrapper">
                ...
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <h2 class="page-title"><?=$title?> | Purchase</h2>
                        </div>
                        <!-- Page title actions -->
            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Export/Purchase</div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="item[]"
                                                            ...
                                                            value="<?= $row['inventory_id'] ?>" checked />
                                                    </td>
                                                    <td>
                                                        <?= $row['item'] ?><br />
                                                    ...
                                                    <td><input type="number" class="form-control" name="qty[]" min="1"
                                                            max="<?= $row['quantity'] ?>">
                                                    </td>
                                                </tr>
                                                <?php endforeach;?>
    ...
    $('#form').submit(function(e) {
        ...
        $.ajax({
            url: "<?=site_url('inventory/item/release')?>",
            method: "POST",
            data: data,
