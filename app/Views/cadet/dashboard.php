                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="card-text">
                                        ...
                                        CvSU-CCC ROTC Unit Portal
                                    </div>
                                    <div class="row gy-3">
                                        <div class="col-12 col-sm d-flex flex-column">
                                            <h2>Welcome back, <?=session()->get('fullname')?></h2>
                                            <p class="mb-5">We're excited to have you with us. To help us better assist
                                                you, please
                                                take a moment to fill out the required form. It will only take a few
                                                minutes, and your input is crucial for us to ensure everything is set up
                                                smoothly for you.
                                            </p>
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <a href="<?=site_url('cadet/profile')?>" class="btn btn-primary">
                                                        Update Profile&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
